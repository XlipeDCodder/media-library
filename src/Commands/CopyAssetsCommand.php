...
namespace Musicplayer\MediaLibrary\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for MediaLibrary plugin.
 *
...
{
    protected $signature = 'nativephp:media-library:copy-assets';

    protected $description = 'Copy assets for MediaLibrary plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for MediaLibrary');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for MediaLibrary');
    }
}